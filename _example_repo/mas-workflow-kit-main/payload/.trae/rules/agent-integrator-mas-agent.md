...
When the user invokes **integrator-mas-agent** or asks to run as this kit agent, follow the protocol below. Canonical source: `.cursor/agents/integrator-mas-agent.md`.
