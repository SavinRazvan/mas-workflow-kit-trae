...
When the user invokes **enterprise-auditor** or asks to run as this kit agent, follow the protocol below. Canonical source: `.cursor/agents/enterprise-auditor.md`.
