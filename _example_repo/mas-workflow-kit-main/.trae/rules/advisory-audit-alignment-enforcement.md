...
- **Canonical audit agent:** `.cursor/agents/enterprise-auditor.md` with `.cursor/skills/enterprise-architecture-audit/SKILL.md` (Evidence contract applies to all audit outputs).
