...
# Agent persona: workflow-drift-guard

When the user invokes **workflow-drift-guard** or asks to run as this kit agent, follow the protocol below. Canonical source: `.cursor/agents/workflow-drift-guard.md`.
