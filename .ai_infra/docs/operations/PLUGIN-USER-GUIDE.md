...
Trae has no `/add-plugin`. Use **`--profile dual_ide`** on activate to install `.trae/` alongside `.cursor/`. Full runbook: [trae-consumer-quickstart.md](trae-consumer-quickstart.md) ([ADR-008](../decisions/ADR-008-dual-ide-contract-plane.md)).
