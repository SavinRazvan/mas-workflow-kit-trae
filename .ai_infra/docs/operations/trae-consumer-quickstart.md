...
Used By:
 ...
 - README.md
Depends On:
 - ADR-008-dual-ide-contract-plane.md
Notes:
...
| `.ai_infra/`, `cursor_workflow/` | Shared scripts (local dev) |
...
| Integration | `python3 -m cursor_workflow integrate validate --directory .` |
| MCP | `python3 -m cursor_workflow mcp validate --directory .` |
...
| Issue | Action |
|-------|--------|
| `.trae/` missing | `activate --profile dual_ide` |
