...
| 5 | [rules-overlap-matrix.md](rules-overlap-matrix.md) | Editing `.trae/rules/*.md` |
...
| [workflow-source-owners.md](workflow-source-owners.md) | Canonical owners: `prepare.py`, `local_workflow_paths.py`, `.trae/` |
...
| [rules-overlap-matrix.md](rules-overlap-matrix.md) | Trae rules inventory (13 files) |
...
| Architecture-impacting audits | `enterprise-auditor` + [.trae/skills/enterprise-architecture-audit/SKILL.md](../../../.trae/skills/enterprise-architecture-audit/SKILL.md) |
