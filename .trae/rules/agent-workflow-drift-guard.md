...
When the user invokes **workflow-drift-guard** or asks to run as this kit agent, follow the protocol below. Canonical source: `.trae/agents/workflow-drift-guard.md`.
